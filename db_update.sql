...
-- MIGRACIÓN CAMPOS PERSONALIZADOS
ALTER TABLE public.campos_personalizados ADD COLUMN IF NOT EXISTS orden INTEGER DEFAULT 0;
ALTER TABLE public.campos_personalizados ADD COLUMN IF NOT EXISTS seccion TEXT DEFAULT 'avanzado';
