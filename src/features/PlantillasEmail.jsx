  ...
  return (
    <div>
      <EncabezadoSeccion title="Plantillas de Correo" sub={`${filtradas.length} plantillas creadas listas para usar`}
        actions={<Btn onClick={() => { 
          if (!checkPlanLimit(db, "plantillas")) return sileo.error(getPlanLimitError("plantillas"));
          setEditando(null); setF({ titulo: "", categoria: "prospectacion", asunto: "", cuerpo: "", tipo: "texto" }); setShowForm(true); 
        }}><Ico k="plus" size={14} />Nueva Plantilla</Btn>} />
