...
export const THEMES = {
  ...
  matte: {
    id: "matte", label: "Negro Mate", icon: "🖤", preview: ["#000000","#D4D4D8","#171717"],
    bg0:"#000000",bg1:"#0A0A0A",bg2:"#121212",bg3:"#1A1A1A",bg4:"#262626",
    border:"#1A1A1A",borderHi:"#262626",
    teal:"#E5E5E5",tealDark:"#FFFFFF",tealSoft:"rgba(229,229,229,.15)",tealGlow:"rgba(229,229,229,.05)",
    btnText:"#000",
    white:"#FFFFFF",whiteOff:"#A3A3A3",whiteDim:"#737373",whiteFade:"#525252",
    green:"#10B981",greenS:"rgba(16,185,129,.12)",
    amber:"#F59E0B",amberS:"rgba(245,158,11,.12)",
    red:"#EF4444",redS:"rgba(239,68,68,.12)",
    grad:"linear-gradient(135deg,#737373,#E5E5E5)",
  },
};
...
export function applyTheme(themeId) {
  ...
  const keys = ["bg0","bg1","bg2","bg3","bg4","border","borderHi","teal","tealDark","tealSoft","tealGlow","btnText","white","whiteOff","whiteDim","whiteFade","green","greenS","amber","amberS","red","redS","grad"];
